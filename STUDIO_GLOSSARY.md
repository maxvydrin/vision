...
| **Team** | Stable group of people that builds/owns/operates work or assets. | The Studio **Team** — a group of *members* (access group); may be seeded from an org Team, membership never auto-synced. |
...
| ----------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| **Organization**              | ⚠️ Both | **Org:** software-producing company or group of companies being modeled. **Studio:** represented by exactly one **Tenant** (1:1).                                                                                                                                                                                                                                | company; org §3.1 · repr §3.1                                                                |
...
| **Team**                      | ⚠️ Both | **Org:** stable group of people that builds, owns, operates, supports or governs work/assets; arrives in Studio as a managed object. **Studio:** the Studio **Team** is a group of *members* — a grantee of roles and a unit of organizing work; may be *seeded* from an org Team, but membership is managed in Studio and never auto-synced.                                                                                              | group · access group (Studio sense); repr §3.1                                               |
...
| **Member** | Studio | Someone using Studio — the vision's Studio "User". Links to at most one Person managed object **per workspace** (a member works across many workspaces — up to one Person in each); holds Role Grants at a scope, directly or via teams. Client access (CLI, IDE plugins, MCP endpoints, API tokens) is member configuration, not a domain entity. | User Identity, Studio User, workspace member |
